...
#sphere, cone, display, color, vector, rate, velocity
...
# But we know that F_total = F_thrust + F_gravity = mass * acceleration - mass * gravity = burn_rate * v_exhaust - burn_rate * t * g_s / (1 + height/R_earth)^2
...
ISS = vis.sphere(pos = [0, 135, 0], radius = 5, color=vis.color.magenta)
